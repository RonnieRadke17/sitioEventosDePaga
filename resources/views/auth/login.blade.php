...
<form method="POST" action="{{ route('signin') }}" class="max-w-md mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-200 dark:text-white dark:bg-gray-600 dark:border-gray-600">
    ...
    <x-forms.input-text type="email" name="email" id="email" description="Correo"></x-forms.input-text>
    ...
    <!-- Campo de contraseña -->
    <x-forms.input-text type="password" name="password" id="password" description="password"></x-forms.input-text>
    {{-- <div class="mb-4">
        <div class="relative">
    ...
    <!-- Botón de acceso -->
    <x-forms.submit-button value='Acceder'></x-forms.submit-button>
