...
class StoreEventMultimediaRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'cover' => 'required|image|mimes:jpg,jpeg,png,gif,svg|max:2048',
            'kit' => 'nullable|image|mimes:jpg,jpeg,png,gif,svg|max:2048',
